    ...
    public  class HyCommands
    {
        ...
        public static void ShowWallBoundaries()
        {
            ...
            using (Transaction tr = db.TransactionManager.StartTransaction())
            {
                ...
                HyCADTool.Tools.ZTools.CreateLayer("HY_Fixed", 1);
                HyCADTool.Tools.ZTools.CreateLayer("HY_Hinged", 3);
        ...
        public static void DrawMeshQuads()
        {
            ...
            using (Transaction tr = db.TransactionManager.StartTransaction())
            {
                ...
                BlockTable bt = (BlockTable)tr.GetObject(db.BlockTableId, OpenMode.ForRead);
                BlockTableRecord btr = (BlockTableRecord)tr.GetObject(db.CurrentSpaceId, OpenMode.ForWrite);
                HyCADTool.Tools.ZTools.CreateLayer("HY_Mesh", 8);
                HyCADTool.Tools.ZTools.CreateLayer("HY_Mesh_Anno", 1);
