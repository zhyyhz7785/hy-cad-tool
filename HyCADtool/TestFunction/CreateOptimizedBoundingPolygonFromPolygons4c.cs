...
namespace HyCADTool
{
    public static partial class TestFunction
    {
        ...
        public static Dictionary<Polyline, List<DBText>> CreateOptimizedBoundingPolygonFromPolygons(List<Dictionary<DBText, ObjectId>> groups, Database db, string layerName, short colorIndex)
        {
