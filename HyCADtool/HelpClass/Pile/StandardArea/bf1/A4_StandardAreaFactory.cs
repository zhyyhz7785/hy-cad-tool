...
namespace HyCADTool.HelpClass
{
    ...
    {
        public static RectangularStandardArea CreateRectangularArea(Polyline polyline, SectionType sectionType, double diameterOrEdge, double scale = 1.0)
        {
        ...
        public static CircularStandardArea CreateCircularArea(Polyline polyline, SectionType sectionType, double diameterOrEdge, double scale = 1.0)
        {
            Editor ed = Application.DocumentManager.MdiActiveDocument.Editor;
