...
namespace HyCADTool.HelpClass.CreatBase
{
    public partial class ElevationModelGenerator
    {
        ...
        {
            Bufferid1 = Tools.Tools.CreateLayer("00_Hy_buffer_1", 36);
            Bufferid2 = Tools.Tools.CreateLayer("00_Hy_buffer_2", 140);
            Bufferid3 = Tools.Tools.CreateLayer("00_Hy_buffer_3", 72);
            Bufferid4 = Tools.Tools.CreateLayer("00_Hy_buffer_4", 150);
            Bufferid_Region = Tools.Tools.CreateLayer("00_Hy_buffer_Bufferid_Region", 66);
            Bufferid_Base = Tools.Tools.CreateLayer("00_Hy_buffer_Bufferid_Base", 137);
            Bufferid_Wall = Tools.Tools.CreateLayer("00_Hy_buffer_Bufferid_Wall", 253);
            try
            {
