...
//        //    //*************！！！！！（5个小时找到的Bug）
//        //    // 修复：先判断 IntersectionsShortestLine
//        //    if (IntersectionsShortestLine == null)
//        //    {
//        //        // 对于空的情况，根据业务需求选择处理方式
//        //        // 例如：直接返回当前 secantLinePri 或者返回 null
//        //        return secantLinePri; // 或 return null;
//        //    }
...
//            if (IntersectionsShortestLine == null)
//            {
//                // 当没有最短交线时，使用 secantLinePri 的 Y 坐标加上 Step/5 作为下一条割线
//                height += Step / 5.0; // 使用 5.0 确保浮点运算
//                SecantLineNext = GetSecantLineX(height);
//                return SecantLineNext;
//            }
//            // 正常情况下的迭代逻辑
