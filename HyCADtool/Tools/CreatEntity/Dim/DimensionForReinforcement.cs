...
//        {
//            //// ("01_hy_1钢筋_线钢筋", 1),("01_hy_2钢筋_点钢筋", 2), ("00_hy_3公共_标注1_外", 3), ("00 - Hy - 标注", 4)
//            EtGpt.SetCurrentLayer("00-Hy-标注");
...
//                EtGpt.SetCurrentLayer("00_hy_3公共_标注1_外");
//                DimLeft.ToSpace();
//                DimUp.ToSpace();
//                DimDown.ToSpace();
//                DimRight.ToSpace();
...
//                {
//                    dimsMid = boundLineMid.GetDimsByLines(DimensionDistanceInside, EtGpt.DimensionFor.ForLeft, true).ToList();
//                    dimsPri = boundLinePri.GetDimsByLines(DimensionDistanceInside, EtGpt.DimensionFor.ForLeft, true).ToList();
...
//                else
//                {
//                    dimsMid = boundLineMid.GetDimsByLines(DimensionDistanceInside, EtGpt.DimensionFor.ForRight, true).ToList();
//                    dimsPri = boundLinePri.GetDimsByLines(DimensionDistanceInside, EtGpt.DimensionFor.ForRight, true).ToList();
//                    //dimsMid = CompareDim(dimsMid, dimsPri);
//                    dimIns.Add(dimsMid.ToArray());
//                    lDPriR = boundLineMid.GetBoundXYFromEntities(RecT.MaxMinPoint.xmax);
//                    dimsPri = dimsMid;
...
//                {
//                    dimsMid = boundLineMid.GetDimsByLines(DimensionDistanceInside, EtGpt.DimensionFor.ForDown, true).ToList();
//                    dimsPri = boundLinePri.GetDimsByLines(DimensionDistanceInside, EtGpt.DimensionFor.ForDown, true).ToList();
//                    //dimsMid = CompareDim(dimsMid, dimsPri);
//                    dimIns.Add(dimsMid.ToArray());
...
//                else
//                {
//                    dimsMid = boundLineMid.GetDimsByLines(DimensionDistanceInside, EtGpt.DimensionFor.ForUp, true).ToList();
//                    dimsPri = boundLinePri.GetDimsByLines(DimensionDistanceInside, EtGpt.DimensionFor.ForUp, true).ToList();
//                    //dimsMid = CompareDim(dimsMid, dimsPri);
//                    dimIns.Add(dimsMid.ToArray());
//                    lDPriD = boundLineMid.GetBoundXYFromEntities(RecT.MaxMinPoint.xmax);
//                    dimsPri = dimsMid;
...
//        {
//            //1 得到分割线
//            var lines = GetAllSecantLineUpDown();
...
//            return dims;
//        }
//        public static RotatedDimension[] CreatDimensionFormPointsOutside(this Point3d[] points,
...
//            return dims.ToArray();
//        }
//        public static RotatedDimension[] CreatDimensionFormPointsInside(
//            this Point3d[] points, DimensionFor dimensionFor)
//        {
//            var ds = points.GetBoundFromEntities();
//            double angele = 0;
//            var piontDistance = new Point3d();
...
//        /// <param name="y"></param>
//        /// <returns></returns>
//        public static Line GetSecantLineUpDown(double y)
//        {
...
//        /// <returns></returns>
//        public static Line[] ChangeLineDirectionUpDown(this Line[] lines)
//        {
...
//        /// <returns></returns>
//        public static Line GetSecantLineNextUpDown(Line IntersectionsShortestLine, Line secantLinePri)
//        {
//            //默认开始迭代高度为，上一次割线求得最短交线的起点位置+步长
...
//            //如果上一次割线求得交线数量大于2，割线迭代位置改为 上一次割线求得最短交线的终点位置+步长
//            //*************！！！！！（5个小时找到的Bug）
//            var SecantLineNext = new Line();
//            //当交线数量超过或不等于 2循环结束  当迭代割线高度  > 最小交线高度时循环结束
//            while (countPri == countNext && height <= IntersectionsShortestLine.EndPoint.Y)
//            //while (count == 2 && height <= IntersectionsShortestLine.EndPoint.Y)
//            {
//                height = height + Step;
//                SecantLineNext = GetSecantLineUpDown(height);
//                countNext = SecantLineNext.GetIntersectionPointsByPolyBoundary(Boundary).Count;
//            }
//            return SecantLineNext;
//        }
//        public static Line[] GetAllSecantLineUpDown()
//        {
...
//            //得到第一条割线
//            secantLinePri = GetSecantLineUpDown(YMin.Y + StartStep);
...
//                //  3 交线方向统一;
//                ChangeLineDirectionUpDown(lineIntersections);
//                //  3 得到最短的交线                
//                var IntersectionsShortestLine = lineIntersections.OrderBy(x => x.EndPoint.Y).FirstOrDefault();
//                //  4 的到新的割线,
//                secantLineNext = GetSecantLineNextUpDown(IntersectionsShortestLine, secantLinePri);
//                //  5 迭代变量,
...
//            var SecantLineNext = new Line();
//            //当交线数量超过或不等于 2循环结束  当迭代割线高度  > 最小交线高度时循环结束
//            while (countPri == countNext && height <= IntersectionsShortestLine.EndPoint.X)
//            {
//                height = height + Step;
...
//            }
//            var resoult = EtGpt.TransformArrayTo2d(list.ToArray());
//            return resoult;
//        }
