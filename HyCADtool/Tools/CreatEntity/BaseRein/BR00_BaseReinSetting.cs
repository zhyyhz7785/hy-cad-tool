...
namespace HyCADTool
{
    public static partial class BaseRein
    {
        ...
        public static void SetUp()
        {
            ...
            // 创建所需的图层          
            Tools.ZTools.CreateMultipleLayers(
            ...
            Tools.ZTools.CreateTextStyle(Tools.ZTools.TextStyleConfig.Name);
            Tools.ZTools.CreateDimStyle(Tools.ZTools.DimStyleConfig.Name);
            Tools.ZTools.CreateMLeaderStyle(Tools.ZTools.MLeaderStyleConfig.Name);
        }
    }
}
