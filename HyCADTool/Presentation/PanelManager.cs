        ...
        private void TryStripCrossSectionCaptionIfDocked()
        {
            ...
            _crossSectionPanel.Dispatcher.BeginInvoke(
                ...
                new Action(() =>
                {
                    try
                    {
                        HyCADTool.Shared.AutoCAD.UI.PaletteTitleBarStripper.TryStripCaption("横断面绘制");
                    }
                    catch
                    {
                    }
        ...
        private void TryStripProjectTreeCaptionIfDocked()
        {
            ...
            _projectTreePanel.Dispatcher.BeginInvoke(
                ...
                new Action(() =>
                {
                    try
                    {
                        HyCADTool.Shared.AutoCAD.UI.PaletteTitleBarStripper.TryStripCaption("项目树");
                    }
                    catch { }
                }));
        }
        ...
        private void TryStripAlignmentCaptionIfDocked()
        {
            ...
            _alignmentPanel.Dispatcher.BeginInvoke(
                ...
                new Action(() =>
                {
                    try
                    {
                        HyCADTool.Shared.AutoCAD.UI.PaletteTitleBarStripper.TryStripCaption("路线工作台");
                    }
                    catch
                    {
                    }
        ...
        private void TryStripBlenderCaptionIfDocked()
        {
            ...
            _blenderPanel.Dispatcher.BeginInvoke(
                ...
                new Action(() =>
                {
                    try
                    {
                        HyCADTool.Shared.AutoCAD.UI.PaletteTitleBarStripper.TryStripCaption("HyCAD 命令");
                    }
                    catch
                    {
                    }
