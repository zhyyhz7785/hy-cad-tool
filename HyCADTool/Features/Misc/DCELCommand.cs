...
namespace HyCADTool.Features.Misc
{
    ...
    public class DCELCommand
    {
        ...
        public DCELCommand()
        {
            _curveExtractor = HyCADTool.Shared.Bootstrap.ServiceLocator.Resolve<ICurveSegmentExtractor>();
            _dcelBuilder = HyCADTool.Shared.Bootstrap.ServiceLocator.Resolve<IDCELBuilderService>();
            _dcelRenderer = HyCADTool.Shared.Bootstrap.ServiceLocator.Resolve<IDCELRenderer>();
        }
