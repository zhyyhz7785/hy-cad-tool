...

{
    ...
    /// 阶段 B C1：独立图形分组 + 割线土/气分析，命令行报告并可视化。

    /// </summary>

    public sealed class DebugRegionBoundaryCommand

    {
...

        {
            ...
            ed.WriteMessage(
                $"\n[阶段B] 埋置深度={embedmentDepth:F2}m  基础底面标高={foundationElevation:F2}m  " +
