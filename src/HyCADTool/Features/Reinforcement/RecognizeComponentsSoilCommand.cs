...
{
    /// <summary>
    /// N12：当前与 N8 相同逻辑（复制自 RecognizeComponentsCommand，供后续独立修改）。
    /// </summary>
    public sealed class RecognizeComponentsSoilCommand
    {
        public void Execute()
        {
            ...
            ed.WriteMessage($"\n[N12] 构件识别完成：{allComponents.Count} 个区域，预览 {drawn} 个实体。");
        }
    }
}
