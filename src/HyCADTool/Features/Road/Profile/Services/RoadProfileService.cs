...
namespace HyCADTool.Features.Road.PlanProfile.Services
{
    /// <summary>
    /// 纵断面服务。
    ///
    ...
    public sealed class RoadProfileService
    {
        ...
        public (global::HyCADTool.Domain.Models.Road.Profile profile, bool created) GetOrCreateDesignProfile(string documentName, Guid alignmentId)
        {
            var (design, alignment) = ResolveAlignment(documentName, alignmentId);
        ...
        private bool TryResolve(string documentName, Guid alignmentId, Guid profileId,
            out RoadDesign design, out global::HyCADTool.Domain.Models.Road.Profile profile, out Alignment alignment)
        {
            design = null;
            profile = null;
            alignment = null;
