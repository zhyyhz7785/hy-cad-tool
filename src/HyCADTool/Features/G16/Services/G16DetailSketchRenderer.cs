...
namespace HyCADTool.Features.G16.Services
{
    public static class G16DetailSketchRenderer
    {
        private const string LayerConcrete = "G16-混凝土";
        private const string LayerRebar = "G16-钢筋";
        private const string LayerDim = "G16-标注";
        private const string LayerText = "G16-文字";
