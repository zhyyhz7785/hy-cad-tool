...
namespace HyCADTool.App.Bootstrap
{
    ...
    public class AutofacModule : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            // 选择过滤服务（单例）
            builder.RegisterType<HyCADTool.Shared.AutoCAD.Selection.SelectionFilterService>()
            ...
            builder.RegisterType<HyCADTool.Shell.Views.FilterPanel>()
                .AsSelf()
                .InstancePerDependency();
            builder.RegisterType<HyCADTool.Features.Tables.Views.TablePanel>()
                .AsSelf()
                .InstancePerDependency();
            ...
            // DCEL 命令
            builder.RegisterType<HyCADTool.Features.Misc.DCELCommand>()
                .AsSelf()
                .InstancePerDependency();

            // === 阶段 7: OverKill 命令 ===
            // OverKill 命令（线段清理）
            builder.RegisterType<OverKillCommand>()
                .AsSelf()
                .InstancePerDependency();
            ...
            builder.RegisterType<HyCADTool.Shared.AutoCAD.Services.MarkerLayerService>()
                .AsSelf()
                .SingleInstance();
            ...
            builder.RegisterType<HyCADTool.Domain.Services.Road.NotImplementedCorridorMeshBuilder>()
                .As<HyCADTool.Domain.Services.Road.ICorridorMeshBuilder>()
                .SingleInstance();

            // 三维导出端口（v1 占位，v2 替换为 GltfExportPort）
            builder.RegisterType<HyCADTool.Domain.Ports.Road.NotImplementedThreeDExportPort>()
                .As<HyCADTool.Domain.Ports.Road.IThreeDExportPort>()
                .SingleInstance();

            // 活动道路设计注册表（按文档名索引）
            builder.RegisterType<HyCADTool.Shared.AutoCAD.Services.Road.RoadDesignRegistry>()
                .AsSelf()
                .SingleInstance();

            // JSON I/O 服务
            builder.RegisterType<HyCADTool.Shared.AutoCAD.Services.Road.RoadJsonExportService>()
                .AsSelf()
                .SingleInstance();

            // 045 / M5：项目级注册表（包住 RoadDesignRegistry 做跨 DWG + Data Shortcut）
            builder.RegisterType<HyCADTool.Shared.AutoCAD.Services.Road.RoadProjectRegistry>()
                .AsSelf()
                .SingleInstance();
            ...
            builder.RegisterType<HyCADTool.Domain.Services.Road.HistoryService>()
                .AsSelf()
                .SingleInstance();
            ...
            builder.RegisterType<HyCADTool.Domain.Services.Road.IntersectionDetector>()
                .AsSelf()
                .SingleInstance();

            // M10：平面分段扫掠落图服务。
            builder.RegisterType<HyCADTool.Shared.AutoCAD.Services.Road.RoadPlanDrawService>()
                .AsSelf()
                .SingleInstance();
            ...
            builder.RegisterType<HyCADTool.Shared.AutoCAD.Services.Road.RoadCorridorService>()
                .AsSelf()
                .SingleInstance();
            builder.RegisterType<HyCADTool.Shared.AutoCAD.Services.Road.RoadIntersectionService>()
                .AsSelf()
                .SingleInstance();
            builder.RegisterType<HyCADTool.Shared.AutoCAD.Services.Road.RoadAccessibilityService>()
                .AsSelf()
                .SingleInstance();
            builder.RegisterType<HyCADTool.Shared.AutoCAD.Services.Road.RoadCrosswalkService>()
                .AsSelf()
                .SingleInstance();
            builder.RegisterType<HyCADTool.Shared.AutoCAD.Services.Road.RoadStopLineService>()
                .AsSelf()
                .SingleInstance();
            builder.RegisterType<HyCADTool.Shared.AutoCAD.Services.Road.RoadLaneMarkingService>()
                .AsSelf()
                .SingleInstance();
            builder.RegisterType<HyCADTool.Shared.AutoCAD.Services.Road.RoadArrowMarkingService>()
                .AsSelf()
                .SingleInstance();
            ...
            builder.RegisterType<HyCADTool.Features.Road.Shared.RoadDesignFileWatcher>()
                .AsSelf()
                .SingleInstance();
