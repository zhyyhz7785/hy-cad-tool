...
namespace HyCADTool.Shared.AutoCAD.Configuration
{
    ...
    public static class LayerBuiltinDefaults
    {
        ...
        public const string RaftSlabXTop = "01-hy-1配筋-钢筋线";
        public const string RaftSlabXBottom = "01-hy-1配筋-钢筋线";
        public const string RaftSlabYTop = "01-hy-1配筋-钢筋线";
        public const string RaftSlabYBottom = "01-hy-1配筋-钢筋线";
        public const string RaftTextX = "00-hy-4说明-一般-文";
        public const string RaftTextY = "00-hy-4说明-一般-文";
        public const string RaftDimX = "00-hy-4说明-一般-文";
        public const string RaftDimY = "00-hy-4说明-一般-文";
        ...
        public const string RoadCrossSectionTitleDecoration = "02-hy-3横断-图题";
        public const string RoadCrossSectionOrientation = "02-hy-3横断-注释-文";
