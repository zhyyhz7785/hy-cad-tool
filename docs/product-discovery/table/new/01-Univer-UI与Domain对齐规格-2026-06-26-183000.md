...
| ID | 领域 | 现状 | 目标 | 阶段 |
|---|---|---|---|---|
| G1 | 样式 WYSIWYG | v1 无 style 字段 | v2 load 写 FRange 样式 | P1 |
| G2 | Role/FieldKey | 仅 `editable` 布尔 | v2 + protect + Inspector | P3 |
...
- [ ] v2 DTO C#/TS 字段与 §3.4 一致
- [ ] `loadSnapshot` 调用 §3.4 Facade 写样式
- [ ] mm↔px 与 §4.2 常量单测
- [ ] export 仍 **不含** style 反写
