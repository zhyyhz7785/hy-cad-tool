...
> 操作面板分步规划：[016 表格操作面板](./016-表格操作面板-分步规划-2026-06-25-200620.md)（AC11 M0 填值之后的 O1–O6 结构操作）  
> 工作方式范式优先级：[017 面板式 vs 画布命令式](./017-表格制作工作方式对比-产品调研-2026-06-25-220420.md)（**AC11/016 先于 AC10**）
...
- **范式优先级**：方式 B（画布命令式）；**暂缓至 AC9 达标**，见 [017 §6.2](./017-表格制作工作方式对比-产品调研-2026-06-25-220420.md)。
...
- **M0 状态（2026-06-25）**：填值 DataGrid + Pick + Publish 已落地；结构操作见 **AC11b**  below。
- **主范式**：方式 A（面板式），见 [017](./017-表格制作工作方式对比-产品调研-2026-06-25-220420.md)。

### AC11b · WPF 操作面板（Step1–3，Should）

- **目标**：TablePanel 操作区 O1–O4（新建空表、行列 Numeric、插删行列、合并/拆分）+ 双模式 Toggle；详见 [016 §4](./016-表格操作面板-分步规划-2026-06-25-200620.md)。
- **验收线**：新建 5×4 → 插 1 行 → merge 2×2 → Publish 目视正确；填值模式锁结构按钮。
- **依赖**：AC11 M0；Domain `GridEditor` / `TableOperation` 已有，无新类型。
- **风险**：窄面板 merge 用 Anchor+span 对话框，不做拖拽。
