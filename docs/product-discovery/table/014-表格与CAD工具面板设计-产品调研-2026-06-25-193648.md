...
> 上游：[001 表格工具调研](./001-AutoCAD表格工具-产品调研-2026-06-24-192049.md)、[002 双模式编辑](./002-统一表格Domain与双模式编辑-产品调研-2026-06-24-225625.md)、[012 排版策略](./012-表级结构优先与内容驱动排版-2026-06-25-185703.md)、[013 竖排文字](./013-表格竖排文字-产品调研-2026-06-25-192651.md)、[015 面板设置](./015-表格面板设置-产品调研-2026-06-25-194246.md)  
...
**第一步**：在 `HyBlenderPanel` 增加「表格」Tab，落地 `TablePanel` MVP（DataGrid + Pick + Publish），再叠 012/013 折叠属性；**设置控件明细**见 [015 §5](./015-表格面板设置-产品调研-2026-06-25-194246.md)。
