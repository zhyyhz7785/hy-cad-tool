...
using DomainGeom = HyCADTool.Refactored.Domain.ValueObjects.Geometry;
using DomainRoad = HyCADTool.Refactored.Domain.Models.Road;

namespace HyCADTool.Refactored.Infrastructure.AutoCAD.Geometry
{
    /// <summary>
