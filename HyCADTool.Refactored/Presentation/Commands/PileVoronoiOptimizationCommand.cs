...
using HyCADTool.Refactored.Infrastructure.AutoCAD.Helpers;
...
namespace HyCADTool.Refactored.Presentation.Commands
{
    ...
    public class PileVoronoiOptimizationCommand
    {
        ...
        public PileVoronoiOptimizationCommand()
        {
            ...
            _db = _doc.Database;
            _ed = _doc.Editor;
            _voronoiService = Infrastructure.Configuration.ServiceLocator.Resolve<VoronoiOptimizationService>();
        }
