...
namespace HyCADTool.Refactored.Presentation.Commands
{
    ...
    public static class ShowPanelCommand
    {
        ...
        public static void ShowHyToolPanel()
            => OpenTab(ViewModels.HyBlenderPanelViewModel.PreferencesTabKey, "显示面板失败");
        ...
        public static void ShowSettingsPanel()
            => OpenTab(ViewModels.HyBlenderPanelViewModel.PreferencesTabKey, "显示设置面板失败");

        /// <summary>显示过滤 Tab。</summary>
        public static void ShowFilterPanel()
            => OpenTab(ViewModels.HyBlenderPanelViewModel.FilterTabKey, "显示过滤面板失败");
