...
//   - 复用 HyCADTool.Refactored.Infrastructure.Commands.CommandCatalog 解析 commands.json
//     （与 Blender 面板 / Ribbon / CUIX 共用同一份命令目录，避免双解析）
//   - 反射目标程序集 = Assembly.GetExecutingAssembly() = HyCADTool.Refactored.dll 自己
...
namespace HyCADTool.Refactored.Production
{
    ...
    {
        private const string VmType = "HyCADTool.Refactored.Presentation.ViewModels.SettingsPanelViewModel";
