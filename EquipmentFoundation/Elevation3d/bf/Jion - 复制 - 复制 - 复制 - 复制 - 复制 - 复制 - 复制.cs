...
//            qb1 = CreateWallBuffer(q1, thickness1);
//            qb2 = CreateWallBuffer(q2, thickness2);
...
//                else
//                {
//                    Polyline qj = CreateBufferPolyline(p14, p13, p22, p21); // 修复：使用 4 个点
...
//            }
//        }
//        public static Polyline CreateBufferPolyline(Point3d p1, Point3d p2, Point3d p3, Point3d p4)
//        {
//            // 创建由四个点组成的闭合 Polyline
...
//                        else
//                        {
//                            qj3 = CreateBufferPolyline(p14, p13, p22); // 第二次声明，冲突
...
//                    else
//                    {
//                        qj3 = CreateBufferPolyline(p14, p13, p22); // 使用第一次声明的 qj3
//                        qb1 = UnionPolylines(qb1, qj3);
//                        qb2 = UnionPolylines(qb2, qj3);
//                    }
//                    break;
...
//            var ed = doc.Editor;
//            // 调试输入
//            ed.WriteMessage($"UnionPolylines 输入: poly1 Vertices={poly1.NumberOfVertices}, poly2 Vertices={poly2.NumberOfVertices}\n");
...
//                {
//                    ed.WriteMessage("错误: 无法创建 Region，poly1 或 poly2 几何错误\n");
...
//                    result.LayerId = ElevationModelGenerator.Bufferid3;
//                    btr.AppendEntity(result);
//                    tr.AddNewlyCreatedDBObject(result, true);
//                    // 调试输出
//                    ed.WriteMessage($"UnionPolylines 输出: result Vertices={result.NumberOfVertices}, Closed={result.Closed}\n");
//                    tr.Commit();
//                    return result;
//                }
//            }
